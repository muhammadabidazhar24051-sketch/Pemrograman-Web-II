...
// =========================================================================
// PROTECTED ROUTES - MULTIPLE CONTROLLERS (MIDDLEWARE AUTH)
// =========================================================================
Route::middleware(['auth'])->group(function () {

    // Pertemuan 14 - Dashboard
    // Route::get('/dashboard', function () {
    //     return view('dashboard');
    // })->name('dashboard');

    // Edit Pertemuan 14 - Tugas 3 - DashboardController
    Route::get('/dashboard', [DashboardController::class, 'index'])->name('dashboard');


    // Pertemuan 14 - Profile Management
    ...
    // Route export exel anggota
    Route::get('/anggota/export', [AnggotaController::class, 'export'])->name('anggota.export');
    Route::get('/anggota/search', [AnggotaController::class, 'search'])->name('anggota.search');

    // Pertemuan 14 - Buku CRUD Resource
    Route::resource('buku', BukuController::class);

    // Pertemuan 14 - Anggota CRUD Resource
    Route::resource('anggota', AnggotaController::class);

    // ============================================================================
    // Route untuk Halaman Laporan & Export PDF (Pertemuan 14 - Tugas 2)
    // ============================================================================
    Route::get('/transaksi/laporan', [TransaksiController::class, 'laporan'])->name('transaksi.laporan');
    Route::get('/transaksi/laporan/pdf', [TransaksiController::class, 'exportPdf'])->name('transaksi.laporan.pdf');

    // Pertemuan 14 - Transaksi CRUD + Custom routes untuk Pengembalian
